...
## For flutter packages run: '''sh pub get'''  && to '''sh run flutter''' project run : '''sh flutter run '''  or in vscode click on run from the banner and click on run without debugging or start degugging.

## For flutter packages run: '''sh pub get'''  && to '''shrun flutter''' project run : '''sh flutter run ''' or in vscode click on run from the banner and click on run without debugging or start degugging.
